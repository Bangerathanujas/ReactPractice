...
var GmailBox = React.createClass({
 ...
 allLabels: function()
 {
     ...
     $.ajax({
      url: 'https://www.googleapis.com/gmail/v1/users/me/labels?key={AIzaSyB2g_3rrEtjC7tSsy70OzhRZxPcxYSZBM8}',
      dataType: 'json',
      type: 'GET',
           ...
           <div className="container-fluid">
             <div className="row">
                 <div className="col-lg-1">
                  <button id="authorize-button" onClick={this.gmailLogin} className="btn btn-primary pull-left">logIn1</button>
                  </div>
